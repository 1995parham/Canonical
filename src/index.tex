...
Besides our duties, people may need features that are not in our roadmap or scope and we need to address these very
...
I think the main mission of Canonical is bringing open source softwares to the hands of people. As an example
when I was a kid, I wanted to a give try to Linux (I only heared its name) and I didn't know where to start, back then
Ubuntu helped me a lot, an open source project with easy to use interface, good documentation and support. I think
Canonical wants to do this in many industries and help people and organizations to resolve their needs with truly free
softwares which is also secure and stable enough.

The main issue with this goal maybe is how we are going to make money, but I am not really concerned about it,
because I think big companies will focus on their main product then out source support for other services and
if those services are from Canonical we can own this support.
